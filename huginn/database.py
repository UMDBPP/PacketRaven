...
class DatabaseTable:
    ...
    def geometry_fields(self) -> {str: type}:
        return {field: field_type for field, field_type in self.fields.items() if isinstance(field_type, BaseGeometry)}
                ...
                if field_type is bool:
                    ...
                    if field_type is list:
                        ...
                        if field_type is date:
                            value = value.date()
                    elif isinstance(field_type, BaseGeometry) or isinstance(field_type, BaseMultipartGeometry):
                        try:
...
def flatten_geometry(geometry: Union[Point, LineString, Polygon, MultiPoint, MultiLineString, MultiPolygon]) -> Union[Point, LineString, Polygon, MultiPoint, MultiLineString, MultiPolygon]:
